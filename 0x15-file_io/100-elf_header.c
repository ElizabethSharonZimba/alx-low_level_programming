 ...
 * @e_ident: array containing the ELF nums
 * Desc: exit code 98
 */
void check_elf(unsigned char *e_ident)
{
...
/**
 * print_magic - Prints magic nums ELF header
 * @e_ident: array containing the ELF nums
 * Desc: nums are separated by spaces
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: prints ELF ABI version
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @argc: num of arg supplied to the program
 * @argv: array opointers to the arg
 * Return: 0
 * Desc: exit code 98
 */
